...
class FullTimeEmployee implements Employee {
    ...
    @Override
    public void updateEmployeeInfo(int id) {
        for (FullTimeEmployee employee : employees) {
            if (employee.id == id) {
                Scanner scanner=new Scanner(System.in);
                ...
                employee.monthsSinceJoining=scanner.nextInt();
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    employeeManager.searchEmployees(searchingID);
                    break;

                case 8:
                    System.out.print("Enter Employee ID to update: ");
                    int updateId = scanner.nextInt();
                    employeeManager.updateEmployeeInfo(updateId);
                    break;
                case 9:
